...
int sender () {
	...
	size_t cwnd = INITIAL_WINDOW;
	// Slow start threshold. If (cwnd <= ssthresh) we do slow-start, else congestion avoidance.
	size_t ssthresh = WINDOW_SIZE;
